...
import Login.MainRequest;
import Login.RegisterCheck;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ---------------------------------------------------------------------------------------
        // 1. 메인 레이아웃 편집
        RelativeLayout mainViewLayout = (RelativeLayout) findViewById(R.id.mainViewLayout);
        CardView cardViewLayout = (CardView) findViewById(R.id.cardViewLayout);
        cardViewLayout.setVisibility(View.GONE);

        mainViewLayout.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Toast.makeText(getApplicationContext(), "아무 화면이나 클릭하세요", Toast.LENGTH_SHORT).show();
    }
